...
#    if !defined(RGB_MATRIX_MAXIMUM_BRIGHTNESS) || !defined(RGB_MATRIX_STARTUP_VAL)
#		undef RGB_MATRIX_MAXIMUM_BRIGHTNESS
#		undef RGB_MATRIX_STARTUP_VAL
#    	define RGB_MATRIX_MAXIMUM_BRIGHTNESS 125    // limits maximum brightness of LEDs, if not defined maximum brightness is set to 255
