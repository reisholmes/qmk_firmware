...
// v4n4g0rth0n - bot layer for gaming switching
#define _BASE_V4N4g0rth0n_4KEY_BOTROW KC_MINS, LT(3, KC_ESC), LT(3, KC_TAB), LT(2, KC_BSPC), LT(1, KC_SPC), LT(4, KC_DEL), LT(4, KC_BSLS), TG(5)
#define _GAME_V4N4g0rth0n_4KEY_BOTROW KC_LCTL, KC_LGUI, KC_LALT, KC_BSPC, KC_SPC, KC_DEL, KC_RGUI, TG(5)
